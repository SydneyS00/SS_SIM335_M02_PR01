...
public class HeroineController : MonoBehaviour
{
    ...
    public IHeroineState _standingState, _jumpingState, _divingState, _duckingState, _walkingState, _shrinkingState, _sneakingState;
    ...
    private void Start()
    {
        ...
        _shrinkingState = gameObject.AddComponent<ShrinkingState>();
    ...
    //SNEAK STATE
    public void HeroineSneak()
    {
        _heroineStateContext.Transition(_sneakingState);
        Debug.Log("Sneak"); 
    }

    //SHRINK STATE
    public void HeroineShrink()
    {
        _heroineStateContext.Transition(_shrinkingState);
        Debug.Log("Shrink"); 
    }
